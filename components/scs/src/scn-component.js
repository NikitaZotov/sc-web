...
$(document).ready(function () {
    SCsConnectors[sc.ScType.ArcAccessConstPosPerm] = "->";
    SCsConnectors[sc.ScType.EdgeCommonConst] = "<=>";
    SCsConnectors[sc.ScType.EdgeCommonVar] = "_==";
    SCsConnectors[sc.ScType.ArcCommonConst] = "=>";
    SCsConnectors[sc.ScType.ArcCommonVar] = "_=>";
    SCsConnectors[sc.ScType.ArcAccessVarPosPerm] = "_->";
});
